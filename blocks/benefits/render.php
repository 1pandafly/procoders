...
<section <?php echo wp_kses_data( $wrapper_attributes ); ?>>
	<div class="procoders-benefits__inner">
		...
		<div class="procoders-benefits__grid" data-grid>
			<?php
			// Cards HTML is generated by theme helpers and already escaped/sanitized per field type.
			echo $cards_html; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			?>
		</div>
